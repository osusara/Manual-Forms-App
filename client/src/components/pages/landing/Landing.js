...
const landing = () => (
  <Container fluid={true}>
    <div className="screen1">
      ...
      <div className="dots">
        <Image className="dot1" src={bdot} alt="dot" width="80px" height="80px" />
        <Image className="dot2" src={bdot} alt="dot" width="80px" height="80px" />
        <Image className="dot3" src={bdot} alt="dot" width="80px" height="80px" />
      </div>
    ...
    <div className="screen2">
      ...
      <div className="para2">
        <p className="p2">
          ...
          unconventional project that fuses a wide range of components to bring
          form creation, scanning and statistical analysis into one application.{" "}
        </p>
      </div>
      <div className="pp2">
    ...
    <div className="screen3">
      ...
      <div className="para3">
        <p className="p3">
          Design the form that you wish. Customize it get the fullest use of the
          survey you want to conduct.
        </p>
      </div>
      <div className="pp3">
    ...
    <div className="screen5">
      ...
      <div className="para5">
        ...
        <p className="p5">
          With just one click of a Button now you can get fully analysed results
          for all your survey data.
        </p>
      </div>
      <div className="pp4">
